package com.bharatsync.emailvalidator4j.lexer;

import com.bharatsync.emailvalidator4j.lexer.exception.TokenNotFound;
...
public class EmailLexer {
    ...
    private Optional<TokenInterface> current = Optional.absent();
    ...
    public TokenInterface getCurrent() {
        return this.current.or(new Token("", ""));
    }
